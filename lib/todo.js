...
class Todo {
  ...
  async getList(req, res, next) {
    ...
    const sqlTotal = 'SELECT *, DATE_FORMAT(due_date, "%Y-%m-%d %H:%i:%s") AS due_date_alias, DATE_FORMAT(create_time, "%Y-%m-%d %H:%i:%s") AS create_time_alias, DATE_FORMAT(update_time, "%Y-%m-%d %H:%i:%s") AS update_time_alias FROM todo';
